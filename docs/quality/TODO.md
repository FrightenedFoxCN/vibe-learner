...
| [ ] MQ-06 人格与 Markdown 指令 | 教師人格扩大或拒绝记笔记任务、误认第三方、添加讲解/邀请；格式提醒迁移不稳定，Tavern 会编造关系/共同经历。本轮跨域 shadow suite 再现“姐姐→学习者/医生朋友”和“职业未知→同行”，thinking-disabled 未降低 major 尾部风险。 | [范围候选](evidence/minimax-study-scope-pairs-v1.jsonl)、[人格边界](evidence/minimax-persona-task-boundary-review-v1.json)、[Tavern 迁移](evidence/minimax-tavern-grounding-transfer-review-v1.json)、[跨域 shadow](m3-persona-scene-tavern-shadow-2026-09-13.md)、[格式对照](evidence/minimax-study-format-pairs-v1-grade.json) | 正常/冲突指令和不同人物关系的留出对照；人格措辞与任务权限分开审查；真实浏览器检查列表、围栏、公式及其他所用 Markdown。 |

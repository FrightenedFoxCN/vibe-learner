...
结论是：把模型的自由坐标回归换成真实检测候选选择，在本批简单合成图上明显减少错位；真实照片仍会选错对象，SAM 的框通过也不代表 mask 分割正确。这是候选方案研究，尚不满足生产教学接入或独立留出验收。后续 Bartle/Hatcher 混排书页、Reflection、坐标校准与 DocLayout-YOLO 子图裁剪见[独立书页报告](m3-book-grounding-results-2026-09-12.md)，本文件不把照片结果外推到书页。

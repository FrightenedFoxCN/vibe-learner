...
- Domain-owned strict decoders now cover Tavern, Document, Planning, Persona/Scene, Study, and versioned Document/Planning streams. Their independent live-wire closure gates remain open, and decoder coverage alone does not complete repository-wide Harness adoption.

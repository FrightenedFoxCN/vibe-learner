...
def invalid_geometry(unit, kind):
    ...
    proposal = {'schema_name':'learning-plan-proposal', 'schema_version':'learning-plan-proposal-v2',
    ...
    return LearningPlanProposalV2.model_validate(proposal).model_dump_json()

...
def compare(source: Path, pdf: Path, output: Path, page: int, native_tool: bool = False):
    ...
    baseline = None
    rows = []
    for i, dpi in enumerate([None, None] if native_tool else [100, 180, 180, 100]):
        observed = {}
        sent_dimensions = []
...
if __name__ == '__main__':
    ...
    a=p.parse_args();compare(a.source.resolve(), a.pdf.resolve(), a.output.resolve(), a.page, a.native_tool)

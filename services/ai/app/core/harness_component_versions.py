...
PLANNING_PROMPT_CONTRACT_VERSION = "planning-prompt-v4"
PLANNING_TOOLSET_CONTRACT_VERSION = "planning-toolset-v2"
PLANNING_TOOL_RUNTIME_CONTRACT_VERSION = "planning-tool-runtime-v2"
...
STUDY_CHAT_PROMPT_CONTRACT_VERSION = "study-chat-prompt-v2"

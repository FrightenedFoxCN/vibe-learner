...
2026-09-10：本文件保留 27 项产品/验收待办；下方专项计划还有 2 项解耦和 3 项 Debug 工作，合计 32 项，其中 1 项质量复核暂缓。研究候选不计入任务数。
...
- [统一 Logging 与 Debug](docs/plans/unified-debug.md)：基础诊断与 Persona 纵向链路已完成；剩余 3 项，覆盖全流程、页面/全局视图和性能审计。
